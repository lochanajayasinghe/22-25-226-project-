      ...
      <div className="h-full bg-gradient-to-b from-blue-100 via-blue-400 to-blue-800 p-3">
        ...
        <Sidebar.Items className="bg-transparent">
          <Sidebar.ItemGroup className="bg-transparent space-y-1">
            ...
            <Sidebar.Item
              onClick={() => navigate("/Store_Manager/dashboard/StoreManagerDashboard")}
              icon={HiOutlineHome}
              className={itemClass("/Store_Manager/dashboard/StoreManagerDashboard")}
            >
              Dashboard
            </Sidebar.Item>

            <Sidebar.Item
              onClick={() => navigate("/Store_Manager/dashboard/manage-med")}
              icon={HiOutlineClipboardList}
              className={itemClass("/Store_Manager/dashboard/manage-med")}
            >
             Medicine
            </Sidebar.Item>

            <Sidebar.Item
              onClick={() => navigate("/Store_Manager/dashboard/manage-equip")}
              icon={HiOutlineBeaker}
              className={itemClass("/Store_Manager/dashboard/manage-equip")}
            >
              Equipments
            </Sidebar.Item>

            <Sidebar.Item
              onClick={() => navigate("/Store_Manager/dashboard/alerts")}
              icon={HiOutlineClipboardList}
              className={itemClass("/Store_Manager/dashboard/alerts")}
            >
              Alerts
            </Sidebar.Item>

            <Sidebar.Item
              onClick={() => navigate("/Store_Manager/dashboard/inventory-requests")}
              icon={HiOutlineChartBar}
              className={itemClass("/Store_Manager/dashboard/inventory-requests")}
            >
              Inventory Requests
            </Sidebar.Item>
