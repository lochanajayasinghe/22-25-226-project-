      ...
      <div className="h-full bg-gradient-to-b from-blue-100 via-blue-400 to-blue-800 p-3">
        ...
        <Sidebar.Items className="bg-transparent">
          <Sidebar.ItemGroup className="bg-transparent space-y-1">
            ...
            <Sidebar.Item
              onClick={() => navigate("/Ward_B_Nurse/dashboard/Ward_B_NurseDashboard")}
              icon={HiOutlineHome}
              className={itemClass("/Ward_B_Nurse/dashboard/Ward_B_NurseDashboard")}
            >
              Dashboard
            </Sidebar.Item>

            <Sidebar.Item
              onClick={() => navigate("/Ward_B_Nurse/dashboard/Ward_B_NurseDailyInput")}
              icon={HiOutlineChartBar}
              className={itemClass("/Ward_B_Nurse/dashboard/Ward_B_NurseDailyInput")}
            >
              Daily Input
            </Sidebar.Item>

            <Sidebar.Item
              onClick={() => navigate("/Ward_B_Nurse/dashboard/Ward_B_NurseInventory")}
              icon={HiOutlineChartBar}
              className={itemClass("/Ward_B_Nurse/dashboard/Ward_B_NurseInventory")}
            >
              Inventory
            </Sidebar.Item>
...
export default Ward_B_NurseSidebar;
