...
const Ward_A_NurseDailyInput = () => {
  ...
  // --- WARD CONFIGURATION (Ward A ONLY) ---
  const wards = [
  ...
  return (
    <div style={{ padding: 40, fontFamily: 'Inter, sans-serif', background: '#f8fafc', minHeight: '100vh' }}>
      ...
      <div style={{ marginBottom: 40 }}>
        ...
        <p style={{ color: '#64748b', marginTop: 8 }}>Input daily shift data for Ward A.</p>
      </div>
...
const DailyInputModal = ({ ward, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Logic for generic wards (Not ETU specific logic needed here since it's Ward A)
