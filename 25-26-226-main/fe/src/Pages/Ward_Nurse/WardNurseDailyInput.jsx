...
// Layout is provided by the route; do not wrap pages in the layout again.
import styles from './WardNurseDailyInput.module.css';

const WardNurseDailyInput = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Submitting ETU Shift Data:', { date, shift, ward, data });
    alert(`Data saved for ${ward} - ${shift} on ${date}.\nTotal Arrivals: ${data.admissions}`);
  };
    ...
    <div className={styles.container}>
        ...
        <div className={styles.header}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <h1 className={styles.title}>{ward} Data Entry</h1>
            <select
              id="ward-select"
              value={ward}
          ...
          <p className={styles.subtitle} style={{ marginTop: 8 }}>Log total patient volume for the shift</p>
        </div>
...
export default WardNurseDailyInput;