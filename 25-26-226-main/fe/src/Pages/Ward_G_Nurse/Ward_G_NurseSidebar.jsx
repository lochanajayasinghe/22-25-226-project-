      ...
      <div className="h-full bg-gradient-to-b from-blue-100 via-blue-400 to-blue-800 p-3">
        ...
        <Sidebar.Items className="bg-transparent">
          <Sidebar.ItemGroup className="bg-transparent space-y-1">
            ...
            <Sidebar.Item
              onClick={() => navigate("/Ward_G_Nurse/dashboard/Ward_G_NurseDashboard")}
              icon={HiOutlineHome}
              className={itemClass("/Ward_G_Nurse/dashboard/Ward_G_NurseDashboard")}
            >
              Dashboard
            </Sidebar.Item>

            <Sidebar.Item
              onClick={() => navigate("/Ward_G_Nurse/dashboard/Ward_G_NurseDailyInput")}
              icon={HiOutlineChartBar}
              className={itemClass("/Ward_G_Nurse/dashboard/Ward_G_NurseDailyInput")}
            >
              Daily Input
            </Sidebar.Item>

            <Sidebar.Item
              onClick={() => navigate("/Ward_G_Nurse/dashboard/Ward_G_NurseInventory")}
              icon={HiOutlineChartBar}
              className={itemClass("/Ward_G_Nurse/dashboard/Ward_G_NurseInventory")}
            >
              Inventory
            </Sidebar.Item>
...
export default Ward_G_NurseSidebar;
