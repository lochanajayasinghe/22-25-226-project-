      ...
      <div className="h-full bg-gradient-to-b from-blue-100 via-blue-400 to-blue-800 p-3">
        ...
        <Sidebar.Items className="bg-transparent">
          <Sidebar.ItemGroup className="bg-transparent space-y-1">
            ...
            <Sidebar.Item
              onClick={() => navigate("/Metha/dashboard/MethaRoleDashboard")}
              icon={HiOutlineHome}
              className={itemClass("/Metha/dashboard/MethaRoleDashboard")}
            >
              Dashboard
            </Sidebar.Item>

            <Sidebar.Item
              onClick={() => navigate("/Metha/dashboard/IllnessTrendsPage")}
              icon={HiOutlineChartBar}
              className={itemClass("/Metha/dashboard/IllnessTrendsPage")}
            >
              Trends 
            </Sidebar.Item>

            <Sidebar.Item
              onClick={() => navigate("/Metha/dashboard/IllnessForecast")}
              icon={HiOutlineBeaker}
              className={itemClass("/Metha/dashboard/IllnessForecast")}
            >
              Forecast
            </Sidebar.Item>

            <Sidebar.Item
              onClick={() => navigate("/Metha/dashboard/IllnessAlerts")}
              icon={HiOutlineClipboardList}
              className={itemClass("/Metha/dashboard/IllnessAlerts")}
            >
              Alerts
            </Sidebar.Item>
            <Sidebar.Item
              onClick={() => navigate("/Metha/dashboard/TrainModel")}
              icon={HiOutlineClipboardList}
              className={itemClass("/Metha/dashboard/TrainModel")}
            >
              Data Input
            </Sidebar.Item>
...
export default MethaRoleSidebar;
